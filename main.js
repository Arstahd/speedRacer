...
board.on("ready", function() {
  ...
  CONFIG.TRACKS[3].ctl.on("down", function() {
    if(CONFIG.TRACKS[3].endTime === ""){
      CONFIG.TRACKS[3].endTime = Date.now();
      CONFIG.TRACKS[3].computedTimeSeconds = computeElapsedTime(CONFIG.RELEASE.startTime, CONFIG.TRACKS[3].endTime);
    }
  });
});
